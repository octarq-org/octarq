export const domains = {
  en: {
    ...
    syncIntro: "Select a Cloudflare or DNSPod credentials connection. LED will query active domains and auto-populate your zone details.",
  ...
  zh: {
    ...
    syncIntro: "选择一个 Cloudflare 或 DNSPod 凭据连接。LED 将查询活动域名并自动填充你的区域详情。",
    selectAccount: "选择账户...",
