...
export const ja = {
  ...
  app: {
    ...
    verificationMailNotConfigured: "このインスタンスではメールサービスが設定されていません。管理者に連絡してください。",
  ...
  command: {
    ...
    chat: {
      askAi: "AI に質問",
      placeholder: "AI に何でも質問…（Enter で送信、Esc で検索に戻る）",
      send: "送信",
      stop: "停止",
      thinking: "思考中",
      tokens: "{{count}} トークン",
  ...
  nav: {
    ...
    "console-auth": "認証",
    "console-plugins": "インストール済みプラグイン",
    "instance-console": "インスタンス管理",
    help: "利用ガイド",
  },
  reset: {
    heading: "パスワードのリセット",
