...
export const pt = {
  ...
  app: {
    ...
    verificationMailNotConfigured: "O serviço de e-mail não está configurado nesta instância. Entre em contato com o administrador.",
  ...
  command: {
    ...
    chat: {
      ...
      placeholder: "Pergunte à IA… (Enter para enviar, Esc para voltar à busca)",
      send: "Enviar",
      stop: "Parar",
      thinking: "Pensando",
      tokens: "{{count}} tokens",
      error: "Falha ao obter resposta da IA",
      modeBadge: "Chat de IA",
      backToSearch: "Voltar para a busca",
      inputLabel: "Entrada de mensagem do chat de IA",
      user: "Você",
  ...
  a2ui: {
    ...
    before: "Antes",
    after: "Depois",
    unsupported: "Widget não suportado",
    approval: "Aprovação de ação",
    empty: "Sem dados de gráfico",
  },
  areas: {
  ...
  nav: {
    ...
    "console-auth": "Autenticação",
    "console-plugins": "Plugins instalados",
    "instance-console": "Gerenciamento da instância",
    help: "Manual de uso",
  },
  reset: {
