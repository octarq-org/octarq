...
export const zh: Resources = {
  ...
  app: {
    ...
    verificationMailNotConfigured: "本实例尚未配置邮件服务，请联系实例管理员。",
  ...
  command: {
    ...
    chat: {
      askAi: "向 AI 提问",
      placeholder: "向 AI 提问…（Enter 发送，Esc 返回搜索）",
      send: "发送",
      stop: "停止",
      thinking: "思考过程",
  ...
  nav: {
    ...
    "console-auth": "身份验证",
    "console-plugins": "已安装插件",
    "instance-console": "实例管理",
    help: "使用指南",
  },
  reset: {
    heading: "重置你的密码",
