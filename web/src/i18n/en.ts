...
export const en = {
  ...
  help: {
    title: "Console Operating Manual",
    subtitle: "Console usage workflows, operational notes & FAQs",
    ...
    cat_security: "Authentication & Security",
    cat_portal: "Architecture & Workspace",
    cat_workspace: "Workspace Settings",
    cat_ai: "AI & MCP Protocol",
    cat_events: "Event Center & Webhooks",
