...
export const en = {
  ...
  command: {
    ...
    chat: {
      askAi: "Ask AI",
      placeholder: "Ask AI anything… (Enter to send, Esc to return to search)",
      send: "Send",
      stop: "Stop",
      thinking: "Thinking",
      tokens: "{{count}} tokens",
      ...
      inputLabel: "AI chat message input",
      user: "You",
      assistant: "Assistant",
    },
  },
  a2ui: {
    ...
    before: "Before",
    after: "After",
    unsupported: "Unsupported widget",
  ...
  nav: {
    ...
    "console-auth": "Authentication",
    "console-plugins": "Installed plugins",
    "instance-console": "Instance Management",
    help: "User Manual",
  },
  reset: {
