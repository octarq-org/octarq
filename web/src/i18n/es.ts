...
export const es = {
  ...
  app: {
    ...
    verificationMailNotConfigured: "El servicio de correo no está configurado en esta instancia. Póngase en contacto con el administrador.",
  ...
  command: {
    ...
    chat: {
      ...
      placeholder: "Pregunta a la IA… (Enter para enviar, Esc para volver a la búsqueda)",
      send: "Enviar",
      stop: "Detener",
      thinking: "Pensando",
      tokens: "{{count}} tokens",
      ...
      inputLabel: "Entrada de mensajes del chat de IA",
      user: "Tú",
      assistant: "Asistente",
    },
  },
  a2ui: {
    ...
    before: "Antes",
    after: "Después",
    unsupported: "Componente no soportado",
    approval: "Aprobación de acción",
    empty: "Sin datos de gráfico",
  },
  areas: {
  ...
  nav: {
    ...
    "checkout-promos": "Códigos promocionales",
    profile: "Mi Perfil",
    security: "Seguridad",
    ...
    "console-auth": "Autenticación",
    "console-plugins": "Complementos instalados",
    "instance-console": "Gestión de instancia",
    help: "Manual de uso",
  },
  reset: {
