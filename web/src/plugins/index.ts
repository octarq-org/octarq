...
//
// A commercial build swaps this module for ./index.pro.ts via the `#octarq-plugins`
// alias (see vite.config.ts, keyed on VITE_OCTARQ_PLUGINS=pro). That is the
// frontend analog of a octarq-pro binary calling `app.App.Use(...)` for its Go
