  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        onClick
          ? "cursor-pointer hover:bg-foreground/[0.06] hover:ring-1 hover:ring-inset hover:ring-foreground/10 active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/60"
          : "",
      )}
    >
