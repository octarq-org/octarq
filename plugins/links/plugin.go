...
func (p *Plugin) Describe() plugin.Info {
	return plugin.Info{Title: "Short Links", Description: "Short link creation, custom domain routing, and click analytics.", Icon: "link-2", EnabledByDefault: true, Requires: []string{"dns"}}
}
